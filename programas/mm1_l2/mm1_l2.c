...
int main(){
  ...
  printf("After resetting counter 'PAPI_L2_DCH' [x10^6]: %f\n", \
        (double)(values[0])/1000000);
  printf("After resetting counter 'PAPI_L2_DCA' [x10^6]: %f\n", \
  ...
  printf("After stopping counter 'PAPI_L2_DCH'  [x10^6]: %f\n", \
	 (double)(values[0])/1000000);
  printf("After stopping counter 'PAPI_L2_DCA'  [x10^6]: %f\n", \
	 (double)(values[1])/1000000);
